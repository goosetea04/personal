  ...
  return (
    <div className="w-full h-full overflow-y-auto flex flex-col items-center p-4 pt-20 pb-20">
      ...
      <button 
        ...
        className="mb-12 px-8 py-3 bg-[#39ff14] text-black font-black text-xl hover:bg-white hover:translate-x-1 hover:-translate-y-1 transition-all shadow-[4px_4px_0_white] active:shadow-none active:translate-x-0 active:translate-y-0 border-2 border-black"
      >
        DOWNLOAD CV.PDF
      </button>
